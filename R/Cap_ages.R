#' Cap ages of data frame at minimum and maximum age
#'
#' Takes a data set of read ages and modal ages, and caps these at the minimum and maximum age.
#'
#' @param data a data frame containing the columns modal_age_closest,
#'  modal_age_low, age, corresponding to the modal age closest to the mean,
#'   the lowest modal age, and an age-reading, respectively.
#'  Typically the output generated by the function [Compute_modes()].
